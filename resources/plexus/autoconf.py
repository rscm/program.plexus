...
sopcast_linux_generico = trunkfolder + \
    "/Modules/Linux/Sopcastx86_64i386/sopcast_linux.tar.gz"
openelecx86_64_sopcast = trunkfolder + \
    "/Modules/Linux/x86_64/Openelec/sopcast_openelec64.tar.gz"
openeelcx86_64_acestream = trunkfolder + \
    "/Modules/Linux/x86_64/Openelec/acestream_openelec64_3051.tar.gz"
openelecxi386_sopcast = trunkfolder + \
    "/Modules/Linux/i386/openelec/sopcast_openeleci386.tar.gz"
openeelcxi386_acestream = trunkfolder + \
    "/Modules/Linux/i386/openelec/acestream_openeleci386_303fix.tar.gz"
# gen linux
acestream_linux_x64_generic = trunkfolder + \
    "/Modules/Linux/x86_64/acestream-linux-x86_64_3051.tar.gz"
acestream_linux_i386_generic = trunkfolder + \
    "/Modules/Linux/i386/acestream-linux-i386_303.tar.gz"
# Android
sopcast_apk = trunkfolder + "/Modules/Android/SopCast.apk.tar.gz"
acestreamengine_apk_arm = trunkfolder + \
    "/Modules/Android/AceStream-3.0.6-2in1.apk.tar.gz"
acestreamengine_apk_x86 = trunkfolder + \
    "/Modules/Android/AceStream-3.0.6-2in1.apk.tar.gz"
android_aceengine_arm = trunkfolder + \
    "/Modules/Android/org.acestream.engine-arm-3.0.6.tar.gz"
android_aceengine_x86 = trunkfolder + \
    "/Modules/Android/org.acestream.engine_x86.tar.gz"
android_aceplayer_arm = trunkfolder + \
    "/Modules/Android/AcePlayer-3.0.6-2in1.apk.tar.gz"
android_aceplayer_x86 = trunkfolder + \
    "/Modules/Android/AcePlayer-3.0.6-2in1.apk.tar.gz"
# Mac OSX #TODO
...
# Windows Files
acestream_windows = trunkfolder + \
    "/Modules/Windows/acewindows-aceengine3.0.4.tar.gz"
    ...
    if version_source:
        ...
        try:
            if version_source["sopcast"][platf] != settings.getSetting('sopcast_version'):
                configure_sopcast(version_source["sopcast"][platf])
            sopcast_update = True
        except:
            sopcast_update = False
        try:
            if version_source["acestream"][platf] != settings.getSetting('acestream_version'):
                configure_acestream(version_source["acestream"][platf])
...
def configure_sopcast(latest_version):
    ...
    if xbmc.getCondVisibility('system.platform.linux') and not xbmc.getCondVisibility('system.platform.Android'):
        ...
        if "arm" in os.uname()[4]:
            ...
            if settings.getSetting('rpi2') == "true":
                ...
                SPSC_KIT = os.path.join(
                    addonpath, sopcast_raspberry.split("/")[-1])
            ...
            if settings.getSetting('openelecx86_64') == "true":
                ...
                SPSC_KIT = os.path.join(
                    addonpath, openelecx86_64_sopcast.split("/")[-1])
                download_tools().Downloader(openelecx86_64_sopcast,
                                            SPSC_KIT, translate(30076), translate(30000))
                if tarfile.is_tarfile(SPSC_KIT):
            ...
            if settings.getSetting('openeleci386') == "true":
                SPSC_KIT = os.path.join(
                    addonpath, openelecxi386_sopcast.split("/")[-1])
                download_tools().Downloader(openelecxi386_sopcast,
                                            SPSC_KIT, translate(30076), translate(30000))
                if tarfile.is_tarfile(SPSC_KIT):
                    download_tools().extract(SPSC_KIT, pastaperfil)
                    xbmc.sleep(500)
        ...
        if generic == True:
            SPSC_KIT = os.path.join(
                addonpath, sopcast_linux_generico.split("/")[-1])
            download_tools().Downloader(sopcast_linux_generico,
                                        SPSC_KIT, translate(30076), translate(30000))
            if tarfile.is_tarfile(SPSC_KIT):
                path_libraries = os.path.join(pastaperfil, "sopcast")
                download_tools().extract(SPSC_KIT, path_libraries)
        ...
        if is_admin == False:
            ...
            try:
                aKey = _winreg.OpenKey(
                    aReg, r'SOFTWARE\SopCast\Player\InstallPath', 0, _winreg.KEY_READ)
                ...
                mensagemprogresso.update(
                    10, translate(30079), translate(30080))
            except:
                sopcast_executable = ""
                mensagemok(translate(30000), translate(
                    30081), translate(30082))
            if not sopcast_executable:
                ...
                aKey = _winreg.OpenKey(
                    aReg, r'SOFTWARE\Microsoft\Windows NT\CurrentVersion\ProfileList')
                users = []
                for i in range(1024):
                    try:
                        ...
                        val = _winreg.QueryValueEx(
                            aKeydois, "ProfileImagePath")
                        try:
                            print(val[0])
                        except:
                            print(
                ...
                if not users:
                    ...
                    xbmc.sleep(1000)
                    cmd = ['sc', 'create', 'sopcastp2p', 'binpath=', os.path.join(
                        os.path.join(sopcast_executable.replace("SopCast.exe", "")), 'srvany.exe')]
                    ...
                    if servicecreator == False:
                        ...
                        mensagemprogresso.update(
                            40, translate(30088), translate(30080))
                        xbmc.sleep(1000)
                        ...
                        try:
                            ...
                            key = _winreg.CreateKey(
                                aReg, r'SYSTEM\CurrentControlSet\Services\sopcastp2p\Parameters')
                            _winreg.SetValueEx(key, 'AppDirectory', 0, _winreg.REG_SZ, os.path.join(
                                sopcast_executable.replace("SopCast.exe", "")))
                            _winreg.SetValueEx(key, 'Application', 0, _winreg.REG_SZ, os.path.join(
                                os.path.join(sopcast_executable.replace("SopCast.exe", "")), "SopCast.exe"))
                            _winreg.SetValueEx(
                                key, 'AppParameters', 0, _winreg.REG_SZ, "sop://")
                            mensagemprogresso.update(
                                50, translate(30090), translate(30080))
                            regedit = True
                        except:
                        ...
                        if regedit == False:
                            ...
                            if len(lines) != 1:
                                ...
                                if permissions == False:
                                    ...
                                    download_tools().Downloader(srvany_permissions, os.path.join(
                                        pastaperfil, "sopcastp2p-permissions.txt"), translate(30097), translate(30000))
                                    xbmc.sleep(500)
                                    ret = mensagemprogresso.create(
                                        translate(30000), translate(30000))
                                    xbmc.sleep(500)
                                    mensagemprogresso.update(
                                        80, translate(30098), "   ")
                                    xbmc.sleep(1000)
                                    cmd = ['regini', os.path.join(
                                        pastaperfil, "sopcastp2p-permissions.txt")]
                                    proc = subprocess.Popen(
                                        cmd, stdout=subprocess.PIPE, shell=True)
                                    for line in proc.stdout:
                                        print(line.rstrip())
                                    ...
                                    if latest_version:
                                        settings.setSetting(
                                            'sopcast_version', value=latest_version)
                                    return
        ...
        sopclient_builtin_location = os.path.join(
            addonpath, "resources", "binaries", "sopclient")
        ...
        if found == True:
            ...
            if os.path.exists(xbmc_data_path) and uid == os.stat(xbmc_data_path).st_uid:
                android_binary_dir = os.path.join(
                    xbmc_data_path, "files", "program.plexus")
                if not os.path.exists(android_binary_dir):
                    os.makedirs(android_binary_dir)
                android_binary_path = os.path.join(
                    android_binary_dir, "sopclient")
                ...
                if not opcao:
                    ...
                    if os.path.exists(os.path.join("sdcard", "Download")):
                        ...
                        sopfile = os.path.join(
                            "sdcard", "Download", sopcast_apk.split("/")[-1])
                    else:
                        dialog = xbmcgui.Dialog()
                        pasta = dialog.browse(
                            int(0), translate(30105), 'videos')
                        sopfile = os.path.join(
                            pasta, sopcast_apk.split("/")[-1])
                    download_tools().Downloader(sopcast_apk, sopfile,
                                                translate(30106), translate(30000))
                    if tarfile.is_tarfile(sopfile):
                        download_tools().extract(sopfile, pasta)
                        download_tools().remove(sopfile)
                    mensagemok(translate(30000), translate(
                        30107), pasta, translate(30108))
                    sopcast_installed = True
...
def configure_acestream(latest_version):
        ...
        if "arm" in os.uname()[4]:
            ...
            if settings.getSetting('rpi2') == "true":
                ACE_KIT = os.path.join(
                    addonpath, acestream_rpi2.split("/")[-1])
                download_tools().Downloader(acestream_rpi2, ACE_KIT,
            ...
            if settings.getSetting('openelecx86_64') == "true":
                ...
                ACE_KIT = os.path.join(
                    addonpath, openeelcx86_64_acestream.split("/")[-1])
                download_tools().Downloader(openeelcx86_64_acestream,
                                            ACE_KIT, translate(30110), translate(30000))
                if tarfile.is_tarfile(ACE_KIT):
                ...
                ACE_KIT = os.path.join(
                    addonpath, acestream_linux_x64_generic.split("/")[-1])
            ...
            if settings.getSetting('openeleci386') == "true":
                ...
                ACE_KIT = os.path.join(
                    addonpath, openeelcxi386_acestream.split("/")[-1])
                download_tools().Downloader(openeelcxi386_acestream,
                                            ACE_KIT, translate(30110), translate(30000))
                if tarfile.is_tarfile(ACE_KIT):
                    download_tools().extract(ACE_KIT, pastaperfil)
                    xbmc.sleep(500)
                ...
                ACE_KIT = os.path.join(
                    addonpath, acestream_linux_i386_generic.split("/")[-1])
  ...
  # Ace
        ...
        if found == True:
            ...
            if "arm" in os.uname()[4]:
                acebundle = os.path.join(
                    pastaperfil, android_aceengine_arm.split("/")[-1])
                download_tools().Downloader(android_aceengine_arm,
                                            acebundle, translate(30111), translate(30000))
            else:
                acebundle = os.path.join(
                    pastaperfil, android_aceengine_x86.split("/")[-1])
                download_tools().Downloader(android_aceengine_x86,
                                            acebundle, translate(30111), translate(30000))
            if tarfile.is_tarfile(acebundle):
                download_tools().extract(acebundle, pastaperfil)
                download_tools().remove(acebundle)
            orgacestreamenginefolder = os.path.join(
                pastaperfil, "org.acestream.engine")
            xbmc_data_path = os.path.join("/data", "data", app_id)
            if os.path.exists(xbmc_data_path) and uid == os.stat(xbmc_data_path).st_uid:
                android_binary_dir = os.path.join(
                    xbmc_data_path, "files", "program.plexus")
                if not os.path.exists(android_binary_dir):
                    os.makedirs(android_binary_dir)
            android_acestream_folder = os.path.join(
                android_binary_dir, "org.acestream.engine")
            ...
            recursive_overwrite(orgacestreamenginefolder,
                                android_acestream_folder, ignore=None)
            pythonbin = os.path.join(
                android_acestream_folder, "files", "python", "bin", "python")
                ...
                if os.path.exists(os.path.join("sdcard", "Download")):
                    ...
                    if "arm" in os.uname()[4]:
                        acefile = os.path.join(
                            "sdcard", "Download", acestreamengine_apk_arm.split("/")[-1])
                    else:
                        acefile = os.path.join(
                            "sdcard", "Download", acestreamengine_apk_x86.split("/")[-1])
                else:
                    dialog = xbmcgui.Dialog()
                    pasta = dialog.browse(
                        int(0), translate(30105), 'myprograms')
                    if "arm" in os.uname()[4]:
                        acefile = os.path.join(
                            pasta, acestreamengine_apk_arm.split("/")[-1])
                    else:
                        acefile = os.path.join(
                            pasta, acestreamengine_apk_x86.split("/")[-1])
                if "arm" in os.uname()[4]:
                    download_tools().Downloader(acestreamengine_apk_arm,
                                                acefile, translate(30117), translate(30000))
                else:
            ...
            if opcao:
                if os.path.exists(os.path.join("sdcard", "Download")):
                    ...
                    if "arm" in os.uname()[4]:
                        acefile = os.path.join(
                            "sdcard", "Download", android_aceplayer_arm.split("/")[-1])
                    else:
                    ...
                    if "arm" in os.uname()[4]:
                        ...
                        acefile = os.path.join(
                            pasta, acestreamengine_apk_x86.split("/")[-1])
                if "arm" in os.uname()[4]:
                    download_tools().Downloader(android_aceplayer_arm,
                                                acefile, translate(30124), translate(30000))
                else:
                    download_tools().Downloader(android_aceplayer_x86,
                                                acefile, translate(30124), translate(30000))
                if tarfile.is_tarfile(acefile):
                    download_tools().extract(acefile, pasta)
                    download_tools().remove(acefile)
